...
- **35 genres is a genuinely hard problem.** Random baseline is 2.9% — the model at 35% is 12× better than chance, using audio features only (no artist identity, no metadata shortcuts).
